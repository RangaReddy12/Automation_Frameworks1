...
String inputpath="E:\\April730Batch\\Atomation_Frameworks\\TestInput\\Controller.xlsx";
String outputpath="E:\\April730Batch\\Atomation_Frameworks\\TestOutput\\KeyOwrdResults.xlsx";
...
public void startTest()throws Throwable
{
	...
	report= new ExtentReports("./ExtentReport/"+FunctionLibray.generateDate()+"  "+"Keyword.html");
	boolean res =false;
	String tcres="";
		...
		//read tcid cell
			...
			for(int j=1; j<=TSCount; j++)
			{
				...
				if(tcid.equalsIgnoreCase(tsid))
				{
					...
					{
						res=FunctionLibray.verifyLogin("Admin", "Admin");
						test.log(LogStatus.INFO, Desription);
					}
					else if(keyword.equalsIgnoreCase("NewBranchCreation"))
					{
						FunctionLibray.clickBranches();
						res=FunctionLibray.verifyNewBranch("Kadiri5", "Anantapur90", "Madanapalli45", "Tanakal", "Kadiri", "45678", "UK", "England", "LONDON");
						test.log(LogStatus.INFO, Desription);
					}
					else if(keyword.equalsIgnoreCase("UpdateBranch"))
					{
						FunctionLibray.clickBranches();
						res=FunctionLibray.verifyBranchUpdate("Srnagar", "Kukatpalli", "98765");
						test.log(LogStatus.INFO, Desription);
					}
