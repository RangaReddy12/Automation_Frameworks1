...
public class HybridDriverScript extends PBConstant{
	String inputpath="E:\\April730Batch\\Atomation_Frameworks\\TestInput\\HybridTest.xlsx";
	String outputpath="E:\\April730Batch\\Atomation_Frameworks\\TestOutput\\HybridResults.xlsx";
	...
	public void startTest()throws Throwable
	{
		...
		report= new ExtentReports("./ExtentReport/"+FunctionLibray.generateDate()+"  "+"Hybrid.html");
		boolean res =false;
		String tcres="";
				...
				for(int j=1; j<=TSCount; j++)
				{
					...
					if(tcid.equalsIgnoreCase(tsid))
					{
						...
						if(keyword.equalsIgnoreCase("AdminLogin"))
						{
							...
							res=FunctionLibray.verifyLogin(user, pass);
						...
						else if(keyword.equalsIgnoreCase("NewBranchCreation"))
						{
							...
							res=FunctionLibray.verifyNewBranch(branchname, Address1, Address2, Address3, Area, Zipcode, country, state, city);
							test.log(LogStatus.INFO, Desription);
						}
						else if(keyword.equalsIgnoreCase("UpdateBranch"))
						{
							...
							FunctionLibray.clickBranches();
							res=FunctionLibray.verifyBranchUpdate(branch, Address1, zip);
							test.log(LogStatus.INFO, Desription);
						}
